...
/**
 * @var array<string,string> Source → badge style. Keys cover every value in
 *      Customer::SOURCES (see src/Models/Customer.php, mirrored from
 *      migrations/016_customer_source_attribution.sql, the source of truth
 *      for the `source` ENUM). Unknown/legacy values fall back to 'other' below.
 */
$sourceBadgeStyle = [
